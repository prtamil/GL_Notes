...
Links: https://www.braynzarsoft.net/viewtutorial/q16390-directx-12-index-buffers
Code: BryanZar Tutorial 06
---
...
14. Execute the commandList to Upload Initial Assets
15. Increment the Fence Values to signal fence as Buffers get uploaded
16. Create Buffer Views
17. Fill out ViewPort
18. Fill out a Scissor Rect
...
```
#### 14. Execute CommandLists to Upload Initial Assets (Triangle data)
```cpp
