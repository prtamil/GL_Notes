...
Links: https://www.braynzarsoft.net/viewtutorial/q16390-directx-12-constant-buffers-root-descriptor-tables
Code: BryanZar Tutorial 08
---
...
15. Create Constant Buffer descriptor Heap, Resource Heap and Map Memory for CPU to update
16. Execute the commandList to Upload Initial Assets
17. Increment the Fence Values to signal fence as Buffers get uploaded
18. Create Buffer Views
19. Fill out ViewPort
20. Fill out a Scissor Rect
...
```
#### 16. Execute CommandLists to Upload Initial Assets (Triangle data)
```cpp
